...
from learnml.utils.api import Sigmoid, TanH, random_arr
...
class LstmNode:
    ...
    def top_diff_is(self, top_diff_h, top_diff_s):
        ...
        di_input = self.sigmoid.gradient(self.state.i) * di
        df_input = self.sigmoid.gradient(self.state.f) * df
        do_input = self.sigmoid.gradient(self.state.o) * do
        dg_input = self.tanh.gradient(self.state.g) * dg
    ...
    def x_list_add(self, x):
        ...
        if len(self.x_list) > len(self.lstm_node_list):
            ...
            lstm_state = LstmState(
                self.lstm_param.mem_cell_ct, self.lstm_param.x_dim)
